...
import stripesImage from "../Images/stripes.png";
import dicesImage from "../Images/red_dice.png";
    ...
    return (
        <div className="mahjong-rules">
            ...
            <div className="mahjong-content">
                ...
                <img src={stripesImage} alt="四川麻将" className="mahjong-image"/>

                <div className="mahjong-subheading">
                    <div
                        className="mahjong-list-item-cn">*刮风下雨：四川麻将的特色玩法，即当有玩家杠牌时，其他玩家须按照杠牌的形式计算番数并立刻结算
                    </div>
                    <div className="mahjong-list-item-en">*King Kongs: Special points calculating method in Sichuan
                        Mahjong, when
