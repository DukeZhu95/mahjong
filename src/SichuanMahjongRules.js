        ...
        <div style={styles.container}>
            ...
            <section>
                ...
                <ul>
                    ...
                    <br></br>
                    <li>诈胡：玩家在胡牌后，若其胡牌的牌型不符合规则，则称为诈胡。诈胡玩家需立即支付给其他玩家四番，若有其他玩家所胡牌型的
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>九莲宝灯：由“1112345678999”另加任意一张相同花色的牌组成的胡牌形态，不另计清一色。
                        <br/> Nine Gates: The hand contains "1112345678999" and one additional tile of the same suit,
                        the point of Pure One Suit cannot be additionally counted.
                    </li>
                    <NineGates/> {/* 在这里插入 nineGates 组件 */}
                    <br></br>

                    <li>三龙七对：七对子的胡牌形态，其中有三组四张相同的牌，不另计根数。
                        <br/> Three Concealed Triplets: The hand contains seven pairs, and there are three groups of
                        four identical tiles, the point of roots cannot be additionally counted.
                    </li>
                    <br></br>

                    <li>清双龙七对：双龙七对 + 清一色的胡牌形态，其中有两组四张相同的牌，不另计根数。
                        <br/> Pure Double Concealed Seven Pairs: Double Concealed Seven Pairs + Pure One Suit, the hand
                        contains two groups of four identical tiles, the point of roots cannot be additionally counted.
                    </li>
                    <br></br>

                    <li>清三龙七对：三龙七对 + 清一色的胡牌形态，其中有三组四张相同的牌，不另计根数。
                        <br/> Pure Three Concealed Triplets: Three Concealed Triplets + Pure One Suit, the hand
                        contains three groups of four identical tiles, the point of roots cannot be additionally counted.
                    </li>
                    <br></br>

                    <li>天胡：庄家唯一的特权，即使用最初摸到的14章牌构成的胡牌，不另计自摸加底。
                        <br/> Heavenly Hand: The dealer's unique privilege, the hand contains 14 tiles that the dealer
                        draws initially, the point of self-drawn win cannot be additionally counted.
                    </li>
                    <br></br>

                    <li>地胡：子家唯一的特权，即使用最初摸到的13章牌构成的胡牌，庄家点炮或自摸皆可，不另计自摸加底。
                        <br/> Earthly Hand: The non-dealer's unique privilege, the hand contains 13 tiles that the
                        non-dealer draws initially, the point of self-drawn win cannot be additionally counted.
                    </li>
                    <br></br>
                </ul>
            </section>
            ...
            <section>
                ...
                <p>四川麻将的计分通常采用番数制，若胡牌后的牌型番数为x，对应的赌注的计算公式为：2<sup>x-1</sup>
                    <br/> Sichuan Mahjong usually uses the points system, if the points of the winning type are x, the
                    formula for calculating the corresponding bet is: 2<sup>x-1</sup>
                </p>
                <p>常见的计番方式如下：
                    <br/> Common points calculating methods are as follows:
                </p>
                <ul>
                    <li>平胡：1番。
                        <br/> Common Hand: 1 point.
                    </li>
                    <br></br>

                    <li>碰碰胡：2番。
                        <br/> All Triplets: 2 points.
                    </li>
                    <br></br>

                    <li>清一色：3番。
                        <br/> Pure One Suit: 3 points.
                    </li>
                    <br></br>

                    <li>七对子：3番。
                        <br/> Seven Pairs: 3 points.
                    </li>
                    <br></br>

                    <li>金钩钓：3番。
                        <br/> Melded Hand: 3 points.
                    </li>
                    <br></br>

                    <li>清对：4番。
                        <br/> Pure Triplets: 4 points.
                    </li>
                    <br></br>
                    ...
                    <li>龙七对：5番。
                        <br/> Concealed Seven Pairs: 5 points.
                    </li>
                    <br></br>

                    <li>清七对：5番。
                        <br/> Pure Seven Pairs: 5 points.
                    </li>
                    <br></br>

                    <li>清金钩钓：5番。
                        <br/> Pure Melded Hand: 5 points.
                    </li>
                    <br></br>

                    <li>双龙七对：7番。
                        <br/> Double Concealed Seven Pairs: 7 points.
                    </li>
                    <br></br>

                    <li>清龙七对：7番。
                        <br/> Pure Concealed Seven Pairs: 7 points.
                    </li>
                    <br></br>
                </ul>

                <p>刮风下雨：四川麻将的特色玩法，即当有玩家杠牌时，其他玩家须按照杠牌的形式计算番数并立刻结算
                    <br/> Special points calculating method in Sichuan Mahjong, when a player Konged, other players must
                    calculate the points according to the type of Kong and settle immediately.
                </p>
                <ul>
                    <li>刮风（明杠）：当玩家持有一组刻子，其他任一玩家打出第四章牌时，则可立即杠牌，点杠玩家须立即结算2番给杠牌玩家。
                        <br/> Exposed Kong: When a player has a triplet, and another player discards the fourth tile of
                        the same kind, the player can Kong, the player who Konged must settle 2 points to the player who
                        Konged.
                    </li>
                    <br></br>

                    <li>刮风（弯杠）：当玩家碰牌后，在自己的摸牌阶段又摸到第四章牌时，则可立即杠牌，场上所有未胡牌玩家须立即结算1番给杠牌
                        玩家（注：若弯杠的牌并非当前摸牌阶段所得，则不进行刮风下雨结算）
                        <br/> Supplemented Kong: When a player Ponged, and draws the fourth tile of the same kind in the
                        draw stage, the player can Kong, all the players who have not won yet must settle 1 point to the
                        player who Konged (Note: If the tile of Kong is not drawn in the current draw stage, the points
                        of this Supplemented Kong cannot be additionally counted).
                    </li>
                    <br></br>

                    <li>下雨（暗杠）：当玩家持有一组刻子，在自己的摸牌阶段又摸到第四章牌时，则可立即杠牌，场上所有未胡牌玩家须立即结算2番
                        给杠牌玩家（注：与其他地区玩法不同，四川麻将暗杠须明牌展示）。
                        <br/> Concealed Kong: When a player has a triplet, and draws the fourth tile of the same kind in
                        the draw stage, the player can Kong, all the players who have not won yet must settle 2 points to
                        the player who Konged (Note: Different from other regions, the Concealed Kong must be shown on
                        the table).
                    </li>
                    <br></br>

                    <li>退税：流局查叫阶段中，未听牌玩家须退回本局刮风（明杠、弯杠）所得（下雨不用退税）
                        <br/> Refund: During the drawn checking stage, the player who did not Ready hand must refund the
                        points of Exposed Kong and Supplemented Kong (Concealed Kong does not need to refund).
                    </li>
                </ul>

                <p>附加计番：<br/> Additional points calculating:</p>
                <ul>
                    <li>根：当玩家胡牌时，牌中四章一样的牌（无论是否杠出）称之为根，结算时每有一根则另加1番。
                        <br/> Roots: When a player wins, the hand contains four identical tiles (no matter Konged or
                        concealed) is called Roots, each Root is additionally counted as 1 point.
                    </li>
                    <br></br>

                    <li>抢杠胡：其他玩家杠牌时（必须为弯杠），加杠的牌恰巧能够构成胡牌，则此杠作废并视为杠牌方点炮，结算时另加1番。
                        <br/> Robbing a Kong: When a player Konged (Supplemented Kong), and the tile of Kong can be used
                        to win, the Kong is invalid and the player who Konged must settle 1 point to the player who wins.
                    </li>
                    <br></br>

                    <li>杠上点炮：当玩家杠牌后的补牌阶段结束后，打出的牌被其他玩家胡牌，则视为杠牌方点炮，此杠的刮风下雨所得须立即转移给胡牌玩家
                        （若为一炮多响则须给每位胡牌玩家转移同等的刮风下雨所得），并在结算时另加1番。
                        <br/> Konged Discard: When a player Konged, and the tile discarded after the draw stage is
                        won by another player, the player who Konged must settle the points of the Kong to the player
                        who wins immediately (if multiple winners, the points must be settled to each winner), and
                        settle 1 point when calculating.
                    </li>
                    <br></br>

                    <li>杠上开花：当玩家杠牌后的补牌阶段恰好摸到了所听的牌，则视为杠牌方自摸胡牌，须在结算时另加2番，并取消自摸加底计算。
                        <br/> Konged Draw: When a player Konged, and draws the tile that the player is waiting for in the
                        draw stage, the player who Konged must settle 2 points when calculating, and cancel the points of
                        self-drawn win.
                    </li>
                    <br></br>

                    <li>海底炮：玩家利用进入流局阶段之前其他玩家打出的最后一张牌胡牌，结算时另加1番。
                        <br/> Last Discard: When a player wins with the last tile discarded by another player before
                        entering the drawn stage, the player must settle 1 point when calculating.
                    </li>

                    <li>
                        海底捞月：玩家利用流局阶段之前摸到的最后一张牌自摸胡牌，结算时另加1番。
                        <br/> Last Draw: When a player wins with the last tile drawn by the player before entering the
                        drawn stage, the player must settle 1 point when calculating.
                    </li>
                </ul>
            </section>
        </div>
